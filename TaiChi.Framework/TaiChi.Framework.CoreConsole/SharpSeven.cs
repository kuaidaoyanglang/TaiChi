...
namespace TaiChi.Framework.CoreConsole
{
    ...
    public class SharpSeven
    {
        public void Show()
        {
            ...
            this.Switch(null);
            this.Switch("HelloDavyHelloDavy");
            this.Switch("HelloDavy");
            #endregion
        ...
        private void Switch(string text)
        {
            ...
            switch (text)
            {
                case "HelloDavyHelloDavy" when k > 10:
                    Console.WriteLine("HelloDavyHelloDavy");
                    break;
                case "HelloDavy" when text.Length < 10:
                    Console.WriteLine("HelloDavy");
                    break;
